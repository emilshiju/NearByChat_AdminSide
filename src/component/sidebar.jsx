...
import { removeUserCredential } from "../redux/authSlice";
...
const SidebarBox = () => {
  ...
  //     className="fixed top-16 left-4 z-50 sm:hidden"
  //   >
  ...
  //             <li
  //               key={index}
  //               className={`flex flex-col rounded-md p-2 cursor-pointer hover:bg-light-white text-gray-300 text-sm items-start gap-x-4 ${
  //                 Menu.gap ? "mt-9" : "mt-2"
  ...
  //         <div className="absolute inset-y-0 right-0 w-px top-4 bg-gray-200"></div>
  //       </ul>
  //     </div>
  //   </aside>
  // </div>
