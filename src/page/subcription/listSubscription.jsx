...
const ListSubscription = () => {
  ...
  function getAllSub() {
    axios
      .get("https://anonymous10.cloud/getAllSearchSubscription")
      .then((res) => {
        if (res.data.data) {
  ...
  const ondeleteSubscription = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`http://localhost:5000/deleteSearchSubscription/${id}`)
          .then((res) => {
            if (res.data.status) {
              getAllSub();
            }
                  ...
                  <div className="overflow-hidden shadow">
                    <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        {allSearchSubscription &&
                          allSearchSubscription.map((a, b) => {
                            return (
                              <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td className="p-4 space-x-2 whitespace-nowrap">
                                  <button
                                    ...
                                    onClick={() =>
                                      redirectToEditSubscription(a._id)
                                    }
                                  >
                                    <svg
