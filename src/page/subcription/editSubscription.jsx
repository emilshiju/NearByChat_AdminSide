...
const EditSubscription=()=>{
    ...
    const formik=useFormik({
     ...
     if(typeof formik.values.image === 'string' ){
      ...
      axios.put('http://localhost:5000/updateSearchSubscription',{data:{name:values.name,maxCount:values.countOfSearch,price:values.price,timePeriod:values.day,description:values.description,imageUrl:values.image},id:id})
      .then((res)=>{
      ...
      uploadBytes(storageRef,values.image).then((snapshot) => {
          ...
          getDownloadURL(snapshot.ref).then((downloadURL)=>{
            ...
            console.log(downloadURL)
                    //  alert(values.price)
             axios.post('/updateSearchSubscription',{data:{name:values.name,maxCount:values.countOfSearch,price:values.price,timePeriod:values.day,description:values.description,imageUrl:downloadURL},id:id})
             .then((res)=>{
   ...
   {console.log("formik errorrrrrrrrrrrrrrrrrrrr")}
    ...
    function getUserDetails(){
      ...
      axios.get(`http://localhost:5000/getCurrentSearchSubscription/${userId}`)
      .then((res)=>{
          if(res.data.data){
