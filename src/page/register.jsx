...
const Register = () => {
  ...
  <div className="bg-white p-8 rounded shadow-md w-full max-w-md" style={{ marginTop: '50px', padding: '20px' }}>
    ...
    <div style={{ marginTop: "30px" }}>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="username" className="block text-gray-700 font-mono">
            Username:
          </label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-gray-700 font-mono">Date of Birth:</label>
        ...
        <p className="text-sm text-gray-600">
          By tapping <strong>“Sign up and accept”</strong>, you acknowledge that you have read the{" "}
          ...
          . Snapchatters can always capture or save your messages, such as by taking a screenshot or using a camera. Be
