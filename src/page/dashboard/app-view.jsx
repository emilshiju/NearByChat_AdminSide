...
const AppView = () => {
  ...
  useEffect(()=>{
    ...
    axios.get('http://localhost:5000/getDashboard')
    .then((a)=>{
      if(a.data.data){

        console.log("alllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll")
        console.log(a.data.week)
        console.log("wekkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk")
        console.log(a.data.weeklyUsers)
  
        console.log("userrrrrrrrrrrrrrrrrrrrrrrrrr")
        console.log(a.data.weeklyOrderes)
        setDailySales(a.data.data.totalAmountDaily[0].totalSum)
  ...
  return (
    <div>
      ...
      <div style={{ paddingTop: '130px',paddingLeft: responsiveMd ?"270px":"0px" }} className=" dark:bg-gray-800">
