...
const SubscriptionList=()=>{
    ...
    useEffect(()=>{
        ...
        axios.get("http://localhost:5000/allSubscriptionDetails")
        .then((res)=>{
console.log(res.data)
 ...
 setOrderSummary(true)
        ...
        axios.get(`http://localhost:5000/getOneSubscriptionSummary/${id}`)
        .then((res)=>{
            if(res.data.data){
    ...
    const [showSummaryIcon,setSummaryIcon]=useState(false)
     ...
     {console.log("alllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll")}
    //  console.log(allSubscriptionDetails)
    ...
    return (
        <div>
            ...
            {!showOrderSummary&&<div style={{ paddingTop: '20px' }}>
      <br></br>
      <div  >
 ...
 <div style={{paddingLeft:"280px",paddingTop:'40px',paddingRight:'10px'}}>
...
<br></br>
 ...
 <div className="flex flex-col" style={{paddingLeft:'280px'}}>
                       ...
                       <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            <thead className="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" className="p-0 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                        timePeriod
                                    </th>
                                    ...
                                    <th scope="col" className="p-0 text-xs font-medium text-center text-gray-500 uppercase dark:text-gray-400 " >
                                        View
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                     {allSubscriptionDetails&&allSubscriptionDetails.map((a,b)=>{
                                        return (
                                    ...
                                    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td className="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                            ...
                                            <div className="text-sm font-normal text-gray-500 dark:text-gray-400">
                                                ...
                                                <div className="text-sm font-normal text-gray-500 dark:text-gray-400">{a?.subscriptionName}</div>
                                            </div>
                                        </td>
                                        <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{a?.userName}</td>
                                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{a?.maxCount}</td>
                                        ...
                                        <VisibilityOffSharpIcon sx={{ color: "white" }}  onClick={()=>onChangeOrderSummary(a?._id)} />:
    ...
    {showOrderSummary&&<div   className=" bg-white dark:bg-gray-800" style={{paddingLeft:'80px',paddingTop:"70px"}}  >

   
    
        <div className="width-[300px] "><section className="bg-white  antialiased dark:bg-gray-800 md:py-16">
       

      <form action="#" className="mx-auto  max-w-screen-xl px-4 2xl:px-0">
     
        <div className="mx-auto max-w-3xl">
        <ArrowBackIcon  style={{color:"white"}} onClick={()=>setOrderSummary(null)} />
        <br></br>
